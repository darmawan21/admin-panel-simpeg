...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2 class="h3 mb-0">Add Work Site</h2>
        ...
        <form action="{{ route('admin.sites.store') }}" method="POST">
            ...
            <div class="row mb-4">
                <div class="col-md-6">
                    ...
                    <input type="number" class="form-control @error('radius') is-invalid @enderror" id="radius" name="radius" value="{{ old('radius', 50) }}" min="10" required>
                ...
                <div class="col-md-6">
                    ...
                    <select class="form-select @error('policy') is-invalid @enderror" id="policy" name="policy" required>
                        <option value="warn" {{ old('policy') == 'warn' ? 'selected' : '' }}>Warn (Allow with flag)</option>
                        <option value="reject" {{ old('policy') == 'reject' ? 'selected' : '' }}>Reject (Block clock-in)</option>
                    </select>
            ...
            <div class="d-flex justify-content-end">
                <button type="submit" class="btn btn-primary px-4">Save Site</button>
            </div>
        </form>
    </div>
</div>
